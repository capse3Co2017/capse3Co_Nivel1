...
uint16_t keypadKeys[CANT_COLUMNAS*CANT_FILAS] = { //      Mapa AsCII
							0x28,          0x2A,  //      0x0a,    0x0b, Enter,Delete,
							0x1F,          0x22,  //      2    ,    5,
							0x1E,          0x21,  //      1    ,    4,
							0x27,          0x20   //      0    ,    3
                          };//KeyBoard KeyCodes HID USB
...
void tecladoConfig( void ){
   ...
   delayConfig( &teclado_debounce, 100 );  // delay no bloqueante para debounce
}
