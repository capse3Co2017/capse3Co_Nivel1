...
uint16_t tecla=0;   //para alojar el codigo leido del teclado
/*****************************************************************************
 * Private functions
 ****************************************************************************/
...
static void Keyboard_UpdateReport(void){
   ...
   else if(tecladoRead(&tecla)){
      HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, tecla); /* Codigo desde la matiz de teclas */
   }
}
